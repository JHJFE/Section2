...
export function getFlight(filterBy = {}) { 
  ...
  //   }, 500);
  // });
  const url = 'http://ec2-13-124-90-231.ap-northeast-2.compute.amazonaws.com:81/' // 엔드포인트

 // let from = 'departure='  + filterBy.departure
 // let to = 'destination=' + filterBy.destination
...
return fetch(`http://ec2-13-124-90-231.ap-northeast-2.compute.amazonaws.com:81/flight?departure=${filterBy.departure}&destination=${filterBy.destination}`)
  ...
  // return fetch(url+`flight?${from}&${to}`).then((res)=>res.json())
